    ...
    return (
        <div>
            <ReactCSSTransitionGroup
                ...
                <Titleh1 name={'Внедрение готовых решений от «Аспро»'} subname={'Запуск сайта на готовом решении; миграция, переезд на 1С-Битрикс. Доработка, развитие и продвижение.'} />
                ...
                <WhiteBlock content={<>
                    <Titleh2 name={'Разработка сайтов на 1С-Битрикс'}
