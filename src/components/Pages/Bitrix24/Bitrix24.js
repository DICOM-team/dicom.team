...
const Bitrix24 = (props) => {
    ...
    return (
        <div>
            ...
            </p></>} Title={'Что такое Битрикс24'} />
            <Separator />
            <TextImg url={'/img/content/kp_1x.png'} text={<> <p>
                Оформленная подписка Битрикс24.Маркет Плюс позволит использовать более 1 500 полезных приложений, представленных в каталоге.
            </p></>} Title={'Битрикс24.Маркет Плюс'} />
            <Separator />
            <Title_h2 name={'Как мы работаем'} subname={'этапы проекта'} />
            <ThreeColums TextColum1={'Аудит'} Text1={'Любой проект начинается с аудита, так как для того чтобы понимать что нужно делать, надо собрать максимально подробную информацию о бизнес-процессах компании.'}
                         TextColum2={'Обучение'} Text2={'Очень важный этап, без обучения успешность внедрения Битрикс24 практически всегда заканчивается саботажем со стороны сотрудников вызванный непониманием логики работы в новой системе.'}
                         TextColum3={'Внедрение'} Text3={'Основной этап работы, на котором мы выполняем все работы по техническому заданию, который сформирован на этапе аудита.'}
            />
